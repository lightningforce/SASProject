...
%let EM_NUM_VARS = 26;
   %macro EM_VARS;
    DemAge DemCluster DemGender DemHomeOwner DemMedHomeValue DemPctVeterans
   GiftAvg36 GiftAvgAll GiftAvgCard36 GiftAvgLast GiftCnt36 GiftCntAll
   GiftCntCard36 GiftCntCardAll GiftTimeFirst GiftTimeLast PromCnt12 PromCnt36
   PromCntAll PromCntCard12 PromCntCard36 PromCntCardAll REP_DemMedIncome
   StatusCat96NK StatusCatStarAll TARGET_B
   %mend EM_VARS;
%let EM_NUM_CLASS = 6;
   %macro EM_CLASS;
    DemCluster DemGender DemHomeOwner StatusCat96NK StatusCatStarAll TARGET_B
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 20;
   %macro EM_INTERVAL;
    DemAge DemMedHomeValue DemPctVeterans GiftAvg36 GiftAvgAll GiftAvgCard36
   GiftAvgLast GiftCnt36 GiftCntAll GiftCntCard36 GiftCntCardAll GiftTimeFirst
   GiftTimeLast PromCnt12 PromCnt36 PromCntAll PromCntCard12 PromCntCard36
   PromCntCardAll REP_DemMedIncome
   %mend EM_INTERVAL;
...
%let EM_NUM_INPUT = 25;
   ...
   GiftCntCard36 GiftCntCardAll GiftTimeFirst GiftTimeLast PromCnt12 PromCnt36
   PromCntAll PromCntCard12 PromCntCard36 PromCntCardAll REP_DemMedIncome
   StatusCat96NK StatusCatStarAll
   %mend EM_INPUT;
%let EM_NUM_BINARY_INPUT = 2;
   %macro EM_BINARY_INPUT;
    DemHomeOwner StatusCatStarAll
...
%let EM_NUM_NOMINAL_INPUT = 3;
   %macro EM_NOMINAL_INPUT;
    DemCluster DemGender StatusCat96NK
   %mend EM_NOMINAL_INPUT;
%let EM_NUM_INTERVAL_INPUT = 20;
